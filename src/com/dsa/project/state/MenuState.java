...
package com.dsa.project.state;


import com.dsa.project.control.Button;
import com.dsa.project.control.RectangleButton;
import com.dsa.project.userinterface.GameFrame;
import com.dsa.project.userinterface.GamePanel;
...
public class MenuState extends State {
    ...
    private com.dsa.project.control.Button[] buttons;
    ...
    public MenuState(GamePanel gamePanel) {
        ...
        buttons = new com.dsa.project.control.Button[NUMBER_OF_BUTTON];
...
//		buttons[1].setPressedBgColor(Color.GREEN);
    ...
    public void Update() {
        for(int i = 0;i<NUMBER_OF_BUTTON;i++) {
            if(i == buttonSelected) {
                buttons[i].setState(com.dsa.project.control.Button.HOVER);
            } else {
                buttons[i].setState(com.dsa.project.control.Button.NONE);
            }
        }
    }
